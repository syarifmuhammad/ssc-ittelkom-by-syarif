<template>
    <div>
        <div>
            <div v-for="tab_list in tab_lists">
                <p>
                    <svg class="svg-inline--fa fa-square-check" aria-hidden="true" focusable="false" data-prefix="far"
    ...
    <div>
        <div>
            ...
            <div>
                ...
                <p>Merupakan registrasi mahasiswa pada setiap semester awal perkuliahan</p>
            </div>
        </div>
    </div>
</template>
